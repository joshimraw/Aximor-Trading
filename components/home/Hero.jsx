...
export default function Hero() {
  return (
    ...
    <section className="hero relative min-h-[90vh] flex items-center justify-center bg-[#0a192f] overflow-hidden">
      ...
      <div className="mt-32 container mx-auto px-2 md:px-6 relative z-10">
