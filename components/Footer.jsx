      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 py-8 border-y border-white/5 mb-8">
          <div className="flex items-center gap-4">
            <div className="text-orange-600"><MapPin size={20} /></div>
            <span className="text-xs uppercase tracking-wider font-semibold">Dhaka, Bangladesh</span>
          </div>
          <div className="flex items-center gap-4">
            <div className="text-blue-600"><Phone size={20} /></div>
            <span className="text-xs uppercase tracking-wider font-semibold">+880 1234 567 890</span>
          </div>
          <div className="flex items-center gap-4">
            <div className="text-emerald-600"><Mail size={20} /></div>
            <span className="text-xs uppercase tracking-wider font-semibold">hello@aximor.com</span>
          </div>
        </div>
